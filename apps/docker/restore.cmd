...
rem  REEMPLAZA los datos: hace TRUNCATE de Exercise/Workout y carga el backup.
...
echo   Backup:  %BACKUP%
echo   Esto BORRA y reemplaza Exercise y Workout en esa BD.
echo ============================================================
...
docker exec -e "PGPASSWORD=%DB_PASS%" %CONTAINER% psql -U %DB_USER% -d %DB_NAME% --single-transaction -v ON_ERROR_STOP=1 -c "TRUNCATE \"Workout\", \"Exercise\" CASCADE;" -f /tmp/restore.sql
if errorlevel 1 (
    echo.
