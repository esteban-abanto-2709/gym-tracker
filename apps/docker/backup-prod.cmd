...
rem ===========================================================================
rem  Backup de PROD: dump de solo datos (Exercise + Workout) de la BD de prod.
...
docker exec -e "PGPASSWORD=%DB_PASS%" %CONTAINER% pg_dump -U %DB_USER% -d %DB_NAME% --data-only --no-owner --no-privileges -t "public.\"Exercise\"" -t "public.\"Workout\"" -f "%TMP_IN_CONTAINER%"
