...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="animate-fade-in-up opacity-0" style={{ animationDelay: '0.3s' }}>
              <p className="text-xl md:text-2xl text-muted-foreground font-light tracking-wide">
                ...
                <span className="text-foreground font-medium">La app que aprende de ti.</span>
              </p>
            </div>
            ...
            <div className="animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s' }}>
              <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Registra cada ejercicio, cada serie, cada progreso. GymTrack analiza tus patrones
                y te sugiere los entrenamientos perfectos para alcanzar tus objetivos.
              </p>
            </div>

            {/* CTA Buttons */}
            <div className="animate-fade-in-up opacity-0 flex flex-col sm:flex-row gap-4 justify-center pt-4"
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group p-8 bg-card rounded-2xl border border-border transition-all duration-300 hover:border-primary hover:shadow-xl hover:-translate-y-1">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Documenta cada ejercicio con series, repeticiones, peso y notas. Tu historial siempre disponible.
                </p>
              </div>
              ...
              <div className="group p-8 bg-card rounded-2xl border border-border transition-all duration-300 hover:border-primary hover:shadow-xl hover:-translate-y-1">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Próximamente: recomendaciones personalizadas basadas en tus patrones y preferencias de entrenamiento.
                </p>
              </div>
              ...
              <div className="group p-8 bg-card rounded-2xl border border-border transition-all duration-300 hover:border-primary hover:shadow-xl hover:-translate-y-1">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Visualiza tu evolución con estadísticas detalladas y gráficos que muestran tu mejora constante.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-12">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl font-bold mb-2">Registra tu entrenamiento</h3>
                  <p className="text-muted-foreground text-lg">
                    Anota cada ejercicio que realizas, con las series, repeticiones y peso que usaste.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl font-bold mb-2">La app analiza tus datos</h3>
                  <p className="text-muted-foreground text-lg">
                    GymTrack identifica patrones: qué grupos musculares trabajas más, cuándo descansas, cómo progresas.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl font-bold mb-2">Recibe sugerencias personalizadas</h3>
                  <p className="text-muted-foreground text-lg">
                    "Hace tiempo que no entrenas pierna. Te sugerimos estos ejercicios que sueles hacer..."
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-linear-to-br from-[hsl(var(--brand-gradient-start))] to-[hsl(var(--brand-gradient-end))] text-white relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Link
                href="/register"
                className="px-8 py-4 bg-white text-[hsl(var(--brand-gradient-start))] rounded-lg font-semibold text-lg transition-all duration-300 hover:bg-opacity-90 hover:shadow-2xl hover:scale-105"
              >
                Crear cuenta gratis
              </Link>
            </div>
      ...
      <footer className="py-12 bg-surface-elevated border-t border-border">
        <div className="container mx-auto px-6">
          <div className="text-center text-muted-foreground">
            <p className="text-sm">
              © 2026 GymTrack. Construido para deportistas que buscan evolucionar.
            </p>
          </div>
        </div>
      </footer>
